				...
				<div class="container">
					<div class="row">
						<div
							...
							<div class="page-title text-center login_imgbiv">
								...
								<p>
									AllForYou is a real-time allergy information check website for allergic patients around the world.<br> For you, for safe food, ALL FOR YOU
								</p>
							</div>
						</div>
					...
					<div class="row">
						...
						<div
									...
									<div class="col-xs-12 col-sm-6 email_length">
										<div class="input-field email">
											<span class="input-icon" id="email"><i
												...
												class="form-control" name="id" placeholder="Please enter your email."></input>
										</div>
									</div>
									<!-- ./col- -->
									<div class="col-xs-12 col-sm-12">
										<div class="input-field">
											<span class="input-icon" id="subject"><i
												...
												class="form-control" name="pwd" placeholder="Please enter your PW."></input>
										</div>
									</div>
									<!-- ./col- -->
									<!--<div class="col-xs-12 col-sm-12">
									...
									<div class="col-xs-12 col-sm-12 div_margin">
										<div class="input-field ">
											<span class="btn-border email_length">
												<button type="submit"
													class="btn btn-primary btn-custom-border text-uppercase email_length">Sign in</button>
											</span>
										</div>
									</div>
								</div>
							...
							<a href="/user/forgot.do" class="a_styl">Forgot password?</a>
							<!--<div class="msg-success">Your Message was sent successfully</div> 
							<div class="msg-failed">뭔가 잘못되었어요, 다시 시도해 보세요</div>-->
						</div>
						<!-- /.col- -->
